...
export const TAX_GLOSSARY: Record<TaxTermId, TaxTerm> = {
  ...
  pit_ytd: {
    nazwa: "Podatek dochodowy wyliczony od początku roku",
    opis: "Podatek dochodowy policzony narastająco od łącznego wyniku. Od tego odejmujemy podatek dochodowy już naliczony za wcześniejsze miesiące.",
    wzor: "skala: do 30 000 zł = 0; potem 12% − 3 600; powyżej 120 000 zł = 32%",
    przyklad: "Wynik roczny 50 000 → podatek 50 000 × 12% − 3 600 = 2 400 zł.",
  },
  pit_miesiac: {
